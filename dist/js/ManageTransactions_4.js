    ...
    if (
        ($(I)
            ...
            .row.add([
                ...
                e.Status == "COMPLETE" ? "ACTIVE" : e.Status,
                e.SL,
                e.TGT2,
                e.TGT3,
                e.TGT4,
...
function buySellPopUp(e, t, a, r, l, i, o, d, n = 1, s = 1, c = 0, p = 0, T = 0, u = 0, v = 0, b = "", g = "", h = 0, y = "", S = "", f = "", L = "", TG = "", SL = "") {
    ...
    if (
        ...
        ("Buy" == P.toLowerCase() ? ($("#txtStopLoss").val(SL > 0 ? SL : 0), $("#txtTarget").val(TG > 0 ? TG : 0)) : ($("#txtStopLoss").val(SL > 0 ? SL : 0), $("#txtTarget").val(TG > 0 ? TG : 0)))),
            0 == b.length)
    ) {
...
function SetCompletedTradeTableDetails(e) {
    ...
    var t,
        a,
        r =
            '<a href="javascript:void(0)" class="GetCompletedTradeDetail" data-bind=' +
            e.Completedtradeid +
            ' ><i class="fa fa-info-circle"></i> </a> <a href="javascript:void(0)" class="DeleteCompletedTrade" data-bind=' +
            e.Completedtradeid +
...
function BindClick() {
    ...
    $(document).on("click", ".GetCompletedTradeDetail", function () {

        $(".hideTranDetailRow").hide();

        var e = $(this).closest("tr");
        var t = $(e).find(".hideTranDetailRow");
