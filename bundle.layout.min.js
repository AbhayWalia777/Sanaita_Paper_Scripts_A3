...
function PaperTradeNotification(){$.ajax({url:"/Trade/GetTotalPaperTradeNotification",type:"GET",success:function(n){n!="0"?$("#PaperTradeNotificationCount").html(n):$("#PaperTradeNotificationCount").html("0");$("#PaperTradeNotificationCount").html(`<div style="position: absolute;top: 13px;right: 0;background-color: blue;color: white;border-radius: 50%;padding: 5px 8px;font-size: 12px;">${n}</div>`)},error:function(){}});$.ajax({url:"/Admin/FundInformationHistoryCount",type:"GET",success:function(n){let t=parseInt(n.Count)||0;if($("#FundNotificationCount").html(`
            <div style="
                position:absolute;
                top:13px;
                right:0;
        ...
        `),t>previousFundCount){toastr.options={closeButton:!0,progressBar:!0,timeOut:0,extendedTimeOut:0,tapToDismiss:!0,newestOnTop:!0,positionClass:"toast-top-right",escapeHtml:!1};let i="";n.Users&&n.Users.length>0&&(i=n.Users.map((n,t)=>{let i=new Date(n.Createddate),r=i.toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"})+" "+i.toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit"});return`
                        <div style="
                            padding:8px;
                            margin-bottom:8px;
...
* Under MIT License
*/
!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):n.metisMenu=t(n.jQuery)}(this,function(n){"use strict";function s(n){for(var i,r,t=1;t<arguments.length;t++)i=null!=arguments[t]?arguments[t]:{},r=Object.keys(i),"function"==typeof Object.getOwnPropertySymbols&&(r=r.concat(Object.getOwnPropertySymbols(i).filter(function(n){return Object.getOwnPropertyDescriptor(i,n).enumerable}))),r.forEach(function(t){var r,u,f;r=n;f=i[u=t];u in r?Object.defineProperty(r,u,{value:f,enumerable:!0,configurable:!0,writable:!0}):r[u]=f});return n}var t,i,e,r,h,o,u,f,c=function(n){function r(t){var u=this,r=!1;return n(this).one(i.TRANSITION_END,function(){r=!0}),setTimeout(function(){r||i.triggerTransitionEnd(u)},t),this}var t="transitionend",i={TRANSITION_END:"mmTransitionEnd",triggerTransitionEnd:function(i){n(i).trigger(t)},supportsTransitionEnd:function(){return Boolean(t)}};return n.fn.mmEmulateTransitionEnd=r,n.event.special[i.TRANSITION_END]={bindType:t,delegateType:t,handle:function(t){if(n(t.target).is(this))return t.handleObj.handler.apply(this,arguments)}},i}(n=n&&n.hasOwnProperty("default")?n.default:n);return r="."+(e=i="metisMenu"),h=(t=n).fn[i],o={toggle:!0,preventDefault:!0,activeClass:"active",collapseClass:"collapse",collapseInClass:"in",collapsingClass:"collapsing",triggerElement:"a",parentTrigger:"li",subMenu:"ul"},u={SHOW:"show"+r,SHOWN:"shown"+r,HIDE:"hide"+r,HIDDEN:"hidden"+r,CLICK_DATA_API:"click"+r+".data-api"},f=function(){function i(n,t){this.element=n;this.config=s({},o,t);this.transitioning=null;this.init()}var n=i.prototype;return n.init=function(){var i=this,n=this.config;t(this.element).find(n.parentTrigger+"."+n.activeClass).has(n.subMenu).children(n.subMenu).addClass(n.collapseClass+" "+n.collapseInClass);t(this.element).find(n.parentTrigger).not("."+n.activeClass).has(n.subMenu).children(n.subMenu).addClass(n.collapseClass);t(this.element).find(n.parentTrigger).has(n.subMenu).children(n.triggerElement).on(u.CLICK_DATA_API,function(r){var u=t(this),f=u.parent(n.parentTrigger),o=f.siblings(n.parentTrigger).children(n.triggerElement),e=f.children(n.subMenu);n.preventDefault&&r.preventDefault();"true"!==u.attr("aria-disabled")&&(f.hasClass(n.activeClass)?(u.attr("aria-expanded",!1),i.hide(e)):(i.show(e),u.attr("aria-expanded",!0),n.toggle&&o.attr("aria-expanded",!1)),n.onTransitionStart&&n.onTransitionStart(r))})},n.show=function(n){var r=this,i,f;this.transitioning||t(n).hasClass(this.config.collapsingClass)||(i=t(n),f=t.Event(u.SHOW),(i.trigger(f),f.isDefaultPrevented())||(i.parent(this.config.parentTrigger).addClass(this.config.activeClass),this.config.toggle&&this.hide(i.parent(this.config.parentTrigger).siblings().children(this.config.subMenu+"."+this.config.collapseInClass)),i.removeClass(this.config.collapseClass).addClass(this.config.collapsingClass).height(0),this.setTransitioning(!0),i.height(n[0].scrollHeight).one(c.TRANSITION_END,function(){r.config&&r.element&&(i.removeClass(r.config.collapsingClass).addClass(r.config.collapseClass+" "+r.config.collapseInClass).height(""),r.setTransitioning(!1),i.trigger(u.SHOWN))}).mmEmulateTransitionEnd(350)))},n.hide=function(n){var r=this,i,f,e;!this.transitioning&&t(n).hasClass(this.config.collapseInClass)&&(i=t(n),f=t.Event(u.HIDE),(i.trigger(f),f.isDefaultPrevented())||(i.parent(this.config.parentTrigger).removeClass(this.config.activeClass),i.height(i.height())[0].offsetHeight,i.addClass(this.config.collapsingClass).removeClass(this.config.collapseClass).removeClass(this.config.collapseInClass),this.setTransitioning(!0),e=function(){r.config&&r.element&&(r.transitioning&&r.config.onTransitionEnd&&r.config.onTransitionEnd(),r.setTransitioning(!1),i.trigger(u.HIDDEN),i.removeClass(r.config.collapsingClass).addClass(r.config.collapseClass))},0===i.height()||"none"===i.css("display")?e():i.height(0).one(c.TRANSITION_END,e).mmEmulateTransitionEnd(350)))},n.setTransitioning=function(n){this.transitioning=n},n.dispose=function(){t.removeData(this.element,e);t(this.element).find(this.config.parentTrigger).has(this.config.subMenu).children(this.config.triggerElement).off("click");this.transitioning=null;this.config=null;this.element=null},i.jQueryInterface=function(n){return this.each(function(){var u=t(this),r=u.data(e),f=s({},o,u.data(),"object"==typeof n&&n?n:{});if(!r&&/dispose/.test(n)&&this.dispose(),r||(r=new i(this,f),u.data(e,r)),"string"==typeof n){if(void 0===r[n])throw new Error('No method named "'+n+'"');r[n]()}})},i}(),t.fn[i]=f.jQueryInterface,t.fn[i].Constructor=f,t.fn[i].noConflict=function(){return t.fn[i]=h,f.jQueryInterface},f});
